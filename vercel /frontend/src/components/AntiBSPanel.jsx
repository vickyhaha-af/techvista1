  ...
  return (
    <div style={{ position: 'relative', width: size, height: size }}>
      ...
      <div style={{
        ...
        <span style={{
          fontFamily: 'var(--font-mono)', fontWeight: 600, fontSize: 24,
          color: 'var(--ink)',
        }}>
        ...
        <span style={{
          ...
          color: 'var(--slate-mid)', textTransform: 'uppercase',
      ...
      {!result ? (
        ...
        >
          ...
          <div style={{
            ...
            <CircularProgress
              value={result.authenticity_score || 0}
              color={getScoreColor(result.authenticity_score || 0)}
            />
            <div style={{ flex: 1 }}>
              <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  flex: 1, height: 8, background: 'var(--cream-deep)',
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                {(result.fluff_words || []).slice(0, 8).map((word, i) => (
                  <span key={i} className="chip gap" style={{ fontSize: 11 }}>
                    {word}
                  </span>
                ))}
              </div>
